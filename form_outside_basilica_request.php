...
render_header('Outside Basilica Request Form', 'services');
?>
<div class="request-paper-wrap">
    <form method="POST" class="request-paper">
        ...
        <div class="paper-checklist">
            <label><input type="checkbox" name="certificate_types[]" value="Certificate of Baptism (Binyag)"> Certificate of Baptism (Binyag)</label>
