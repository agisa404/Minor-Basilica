...
<p class="text-secondary mb-3">Showing requests for <?php echo e(app_now()->format('F Y')); ?> only.</p>

<div class="d-flex flex-wrap gap-2 mb-3">
    <a class="btn btn-outline-light" href="announcements.php">Manage Announcements</a>
    <a class="btn btn-outline-light" href="event_schedule_admin.php">Manage Event Schedules</a>
    <a class="btn btn-outline-light" href="attendance.php">Attendance Monitoring</a>
    <a class="btn btn-outline-light" href="document_requests.php">Document Requests</a>
</div>
                                ...
                                <td>
                                    <?php if (in_array($r['status'], ['pending', 'conflict'], true)): ?>
                                        <form method="POST" class="d-grid gap-2">
                                            ...
                                            <button class="btn btn-sm btn-success" type="submit" name="action" value="confirm">Confirm</button>
