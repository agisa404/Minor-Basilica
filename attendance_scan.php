...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['delete_attendance_id'])) {
    if (!$isAdminStaff) {
        set_flash('danger', 'Only admin/staff can delete attendance records.');
    ...
    <div class="card-body">
        ...
        <div class="table-responsive">
            <table class="table table-dark table-striped align-middle">
                ...
                <tbody>
                    <?php if (!$attendees): ?>
                        <tr><td colspan="<?php echo $isAdminStaff ? '4' : '3'; ?>" class="text-center">No attendance records yet.</td></tr>
                    <?php else: ?>
