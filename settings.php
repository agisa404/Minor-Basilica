    ...
    <div class="col-lg-6">
        <div class="card bg-dark border-warning-subtle">
            <div class="card-body">
                ...
                <select id="themeModeSelect" class="form-select theme-select" aria-label="Theme mode">
    ...
    <div class="col-lg-6">
        <div class="card bg-dark border-warning-subtle">
            <div class="card-body">
                ...
                <small class="text-uppercase d-block mb-3"><?php echo e($user['role']); ?></small>
                ...
                <div class="card-body">
                    ...
                    <form method="POST" class="row g-3 align-items-end">
                        ...
                        <div class="col-md-5">
                            ...
                            <input class="form-control" type="datetime-local" name="app_datetime" value="<?php echo e($appDateTimeInput); ?>">
                        </div>
                        <div class="col-md-7">
                            <div class="d-flex gap-2">
                                <button class="btn btn-warning" type="submit">Save Date/Time</button>
                                <button class="btn btn-outline-light" type="submit" name="app_datetime" value="">Reset to Server Time</button>
                            </div>
